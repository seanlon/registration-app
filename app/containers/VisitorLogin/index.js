...
export default class VisitorLogin extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    <div className={materials.formgroup}>
      ...
      <label htmlFor="select" className={materials.controllabel}><FormattedMessage {...messages.purpose} /></label><i className={materials.bar}></i>
    </div>
    <div className={materials.formgroup}>
    ...
    <div className={materials.formgroup}>
      <input type="text" required="required"/>
      <label htmlFor="input" className={materials.controllabel}><FormattedMessage {...messages.userno} /></label><i className={materials.bar}></i>
    </div>
    <div className={materials.formgroup}>
      <textarea required="required"></textarea>
      <label htmlFor="textarea" className={materials.controllabel}><FormattedMessage {...messages.summary} /></label><i className={materials.bar}></i>
    </div>
   
    <div className={materials.checkbox}>
      <label>
        <input type="checkbox"/><i className={materials.helper}></i><FormattedMessage {...messages.tnc} />
      </label>
    </div>
